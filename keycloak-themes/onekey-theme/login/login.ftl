...
<@layout.registrationLayout displayMessage=true; section>
  <#if section = "form">
    ...
    <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post" class="space-y-6">
      ...
      <button tabindex="4" type="submit" name="login" id="kc-login" onclick="this.disabled=true; this.classList.add('opacity-60','cursor-not-allowed');" class="w-full bg-secondary hover:bg-secondary-600 dark:bg-accent dark:hover:bg-accent-600 text-white py-3 px-4 rounded-lg transition-all hover:shadow-lg flex items-center justify-center gap-2 font-medium">
        <span>Masuk</span>
